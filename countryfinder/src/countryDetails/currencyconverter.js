...
import { currencies } from "./currencyjsonData";
...
const URL = `https://v6.exchangerate-api.com/v6/8d681007dbed3cfd9da1910e/pair`;
...
function CurrencyConverter(props) {
    ...
    let cuntriesOptions = [];
    Object.keys(currencies).map((currency, index) =>{return(
